    ...
    <div className={styles.main}>
      <div className={styles.left}>
        ...
        <div className={styles.mainContent}>
          ...
          <h1 className={styles.title}>Revolutionize <br /> your student <br /> analysis today!</h1>
  ...
  return (
    <div className={styles.topBar}>
      ...
      <div className={styles.topBarRight}>
        ...
        <Button onClick={()=> navigate("/signup")} className={styles.signupButton} variant="contained">
          Signup
        </Button>
      </div>
    </div>
